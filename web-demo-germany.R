...
main_df <- read_xlsx(path = "DemoData_Germany.xlsx", sheet = "DemoData_Germany")
main_df <- as.data.frame(main_df)
names(main_df)

# participant id = 13: North America - Germany - USA
main_df <- subset(main_df, id != 13)

print(count(main_df))

growing_place <- c("Germany", "Turkey")
